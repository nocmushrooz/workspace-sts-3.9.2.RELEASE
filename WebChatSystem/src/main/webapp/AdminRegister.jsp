...
<body>
	...
	<div class="registerUser">
		<form action="AdminRegister" method="POST" name="registerForm">
			...
			<table id="registerTable">
	  			<tbody>
					...
					<tr>
						<td id="label"><label id="registerLabel">Account Type</label></td>
						<td id="textField">
							<input type="radio" name="accountType" value="Admin">Admin 
							<input type="radio" name="accountType" value="User">User
						</td>
					</tr>	
					<tr>
		    			<td id="btnBackTD"><a href="AdminLoginHome.jsp"><input type="button" value="Back" name="btnBack" id="btnRegister" /></a></td>
